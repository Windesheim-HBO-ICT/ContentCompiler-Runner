...
| --- | --- | --- | --- | --- | --- |
| 🔨 | 26. work-in-progress test | 26. work-in-progress test.md | N/A | N/A | Geen taxco gevonden<br>Work-in-progress items gevonden: <br>-=ENUM=- |
...
| Status | File | Path | Taxonomie | Tags | Errors |
| --- | --- | --- | --- | --- | --- |
| ⚠️ | 10. Taxonomie code zonder onderwerp (tc-3) | 10. Taxonomie code zonder onderwerp (tc-3).md | bg-24.2.OI | N/A | Ongeldige taxco:  `bg-24.2.OI` |
| ⚠️ | 11. Taxonomie code zonder niveau (tc-2) | 11. Taxonomie code zonder niveau (tc-2).md | bg-24.Alleen-Niveau-Twee.OI | N/A | Ongeldige taxco:  `bg-24.Alleen-Niveau-Twee.OI` |
| ⚠️ | 12. Taxonomie code zonder tc-1 | 12. Taxonomie code zonder tc-1.md | 2.Alleen-Niveau-Twee.OI | N/A | Ongeldige taxco:  `2.Alleen-Niveau-Twee.OI` |
...
| ⚠️ | 14. Taxonomie code met spaties in tc-3 | 14. Taxonomie code met spaties in tc-3.md | bg-24.2.Alleen Niveau Twee.OI | N/A | Ongeldige taxco:  `bg-24.2.Alleen Niveau Twee.OI` |
| ⚠️ | 15. Taxonomie code tussen tc-1 en tc-2 | 15. Taxonomie code tussen tc-1 en tc-2.md | bg-24. 2.Alleen-Niveau-Twee.OI | N/A | Ongeldige taxco:  `bg-24. 2.Alleen-Niveau-Twee.OI` |
| ⚠️ | 16. Taxonomie code tussen tc-2 en tc-3 | 16. Taxonomie code tussen tc-2 en tc-3.md | bg-24.2. Alleen-Niveau-Twee.OI | N/A | Ongeldige taxco:  `bg-24.2. Alleen-Niveau-Twee.OI` |
| ⚠️ | 17. Taxonomie code tussen tc-3 en tc-4 | 17. Taxonomie code tussen tc-3 en tc-4.md | bg-24.2.Alleen-Niveau-Twee. OI | N/A | Ongeldige taxco:  `bg-24.2.Alleen-Niveau-Twee. OI` |
...
| ❌ | 21. Fouten in dynamisch link opgelost | 21. Fouten in dynamisch link opgelost.md | N/A | N/A | Dynamische link fout:  `[[foutieveLinkEen]]`<br>Dynamische link fout:  `[[foutieveLinkTwee]]`<br>Geen taxco gevonden |
...
| ❌ | 25. 2 van de 5 images gebruikt | 25. 2 van de 5 images gebruikt.md | N/A | N/A | Geen taxco gevonden |
